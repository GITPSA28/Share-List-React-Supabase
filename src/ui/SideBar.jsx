...
export default function SideBar() {
  return (
    <aside className="bg-base-200 text-base-content min-h-full w-56 xl:w-80">
  ...
  return (
    <ul className="menu w-full p-4">
      ...
      <li>
        <Link
          to="/recommendations"
          className={currentPath === "/recommendations" ? "menu-active" : ""}
        >
      ...
      <li>
        <details open>
          ...
          <ul>
            <UserLists currentPath={currentPath} />
            <li>
              <Link
                className={currentPath === "/mylists" ? "menu-active" : ""}
                to={"/mylists"}
              >
                My Lists
              </Link>
...
function UserLists({ currentPath }) {
  const {
    session: {
      user: { id: user_id },
    },
  ...
  return (
    <>
      <li>
        <Link
          to={`/list/${listIds.watchListId}`}
          className={
            currentPath === `/list/${listIds.watchListId}` ? "menu-active" : ""
          }
        >
          {currentPath === `/list/${listIds.watchListId}` ? (
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
              fill="currentColor"
      ...
      <li>
        <Link
          to={`/list/${listIds.favouriteId}`}
          className={
            currentPath === `/list/${listIds.favouriteId}` ? "menu-active" : ""
          }
        >
          {currentPath === `/list/${listIds.favouriteId}` ? (
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
              fill="currentColor"
